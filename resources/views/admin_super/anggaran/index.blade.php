...
<div class="card">
    <div class="card-body">
        ...
        <a href="{{ route('admin_super.ASanggaran.create') }}">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a href="{{ route('admin_super.ASanggaran.edit', $anggaran->id) }}" class="btn btn-warning btn-sm" title="Edit">
                                        ...
                                        <form id="delete-form-{{ $anggaran->id }}" 
                                              action="{{ route('admin_super.ASanggaran.destroy', $anggaran->id) }}" 
                                              method="POST" 
                                              style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        ...
                                        <a href="{{ route('admin_super.ASdetail-anggaran.showByAnggaran', $anggaran->id) }}" class="btn btn-success btn-sm" title="Detail">
                                            <i class="bi bi-eye"></i>
                                        </a>                                        
                                    </div>
                                </td>
